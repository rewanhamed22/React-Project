    ...
    <div className="navbar sticky top-0 z-50 drop-shadow text-white lg:px-8 bg-[#705D9D]">
      <div className="navbar-start text-white">
        ...
        <a className="btn btn-ghost normal-case text-4xl ">
          <Link to="/">
            Breathe
            <img
              className=" btn btn-ghost normal-case lg:text-2xl lg:visible lg:mr-8  "
      ...
      <div className="navbar-end flex justify-end gap-6">
        {localStorage.getItem("userToken") ? (
          <>
            <label tabIndex={0} className=" btn btn-ghost btn-circle hidden lg:avatar   ">
            ...
            <button
              ...
              className="btn bg-transparent p-3 text-white capitalize border-none  hover:bg-white/95 hover:text-[#705D9D] "
            >
              Log Out
            </button>
          </>
          ...
          <>
            <div className="flex gap-4">
              <Link to="/login">
                <button className=" text-white  px-3 cursor-pointer border-none  btn bg-transparent  hover:bg-white/95 hover:text-[#705D9D] capitalize ">
                  Log in
                </button>
              </Link>
              <Link to="/signup">
