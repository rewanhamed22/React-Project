...
const FullPost = () => {
  ...
  return (
    <div>
      <div className="flex flex-col-reverse lg:flex-row w-full bg-white  rounded mt-20  shadow-xl h-[500px] mb-32">
        <div className="w-full lg:w-1/2">
          <div
            aria-label="card"
            className="pt-4 lg:pt-6 pb-4 lg:pb-6 pl-4 lg:pl-6 pr-4 lg:pr-6"
          >
            <div className="flex justify-between sm:items-start md:items-start lg:items-start flex-row lg:flex-col">
              <div className="flex">
                <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
                  <div className="avatar ">
                    <div className=" w-12 h-12 my-auto rounded-full object-fill">
                ...
                <div>
                  <p className="ml-2 mt-3 text-[#705D9D]">{post.userName}</p>
                </div>
              </div>
            </div>
            <h2 className="card-title text-5xl font-bold mb-6 text-[#705D9D] mt-6">
              {post.title}
            </h2>

            <p className="text-[#487EB0]">{post.content}</p>
          </div>
        </div>
