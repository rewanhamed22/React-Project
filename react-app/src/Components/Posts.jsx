...
const Posts = () => {
  ...
  return (
    <div className="max-w-[1640px] m-auto px-4 py-12">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4   gap-12 pt-4">
        {data.map((post) => (
          <div
            key={post.id}
          ...
          >
            ...
            <div className="card-body lg:w-1/2">
              ...
              <h2 className="card-title text-3xl text-blue-900">
                {post.title}{" "}
              </h2>
              </div>
              ...
              <div className="flex flex-row ">
                ...
                <div className=" flex flex-col ">
                  <span className="mx-2 mt-1 text-xl ">{post.userName}</span>
